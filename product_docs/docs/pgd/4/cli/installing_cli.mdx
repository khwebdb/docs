...
When the PGD CLI is configured by TPAexec, it connects automatically, but with a manual installation to a standalone BDR cluster you need to provide a connection string.
